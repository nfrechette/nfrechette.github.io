...
![Compression ratio VS max error per clip](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_compression_ratio_vs_max_error.png)
...
![Compression ratio distribution](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_compression_ratio_distribution.png)
...
![Compression ratio distribution (bottom 10%)](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_compression_ratio_distribution_bottom_10.png)
...
![Compression ratio by clip duration](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_compression_ratio_by_duration.png)
...
![Compression ratio by clip duration (shortest 100)](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_compression_ratio_by_duration_shortest_100.png)

Both algorithms perform similarly for the shortest clips.

## How accurate are we?

![Max error distribution](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_max_error_distribution.png)
...
![Max error by clip duration](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_max_clip_error_by_duration.png)
...
![Distribution of the error for every bone at every key frame](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_exhaustive_error.png)

The above image is amazing!

![Distribution of the error for every bone at every key frame (top 10%)](https://github.com/nfrechette/acl/blob/develop/docs/images/acl_exhaustive_error_top_10.png)
